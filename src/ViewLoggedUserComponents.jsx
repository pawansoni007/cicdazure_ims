...
const ViewLoggedUserComponents = () => {
  ...
  const getComponentsByTeamMember = async () => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/api/AssignComponent/getByUserName`, headers
      );
  ...
  const updateLocation = async () => {
    try {
      await axios.post(
        `${BASE_URL}/api/AssignComponent/UpdateComponentsForUser`,
...
export default ViewLoggedUserComponents;
